...
if (settings.packs.value()) {
  ...
  function showCards(results) {
      ...
      for (var i=0; i < results.list.length;i++) {
          ...
          var thingy = window.appendCard(card,useless)[0];
