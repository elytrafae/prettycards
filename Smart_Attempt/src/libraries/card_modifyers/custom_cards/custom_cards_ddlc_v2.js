...
CustomCardsDictionary.AddCustomCard({
	...
	description: "{{KW:MAGIC}}: Kill an ally {{KW:SACRIFICE}} monster to deal their {{HP}} as {{DMG}} to yourself and trigger its {{KW:SUICIDE}} effect. {{KW:SUICIDE}}: Add a copy of it to your deck with -1 {{cost}}.",
	tribes: ["DOKI"],
	extension: "BASE",
	rarity: "RARE"
});
...
CustomCardsDictionary.AddCustomCard({
	...
	description: "{{KW:TAUNT}}. Whenever this is damaged by a monster, give it {{KR}}. {{KW:SUICIDE}}: Add a random {{TRIBE:DOKI}} from your dustpile back to your hand with -1 {{cost}} and {{KR}}.",
	tribes: ["DOKI"],
	extension: "BASE",
	rarity: "EPIC"
});
...
CustomCardsDictionary.AddCustomCard({
	...
	attack: 4,
	hp: 6,
	description: "{{KW:MAGIC}}: Fully heal all ally {{KW:SACRIFICE}} monsters. {{KW:DELAY}}: Give them +1 {{ATK}}. {{KW:SUICIDE}}: Give all enemy monsters +1 {{HP}} and force them to attack ally {{KW:SACRIFICE}} monsters in front of them.",
	tribes: ["DOKI"],
	extension: "BASE",
	rarity: "LEGENDARY"
});
...
CustomCardsDictionary.AddCustomCard({
	...
	attack: 6,
	hp: 9,
	description: "{{KW:MAGIC}}: Add the " + CustomCardsDictionary.DescriptionArtifact("File Explorer") + " artifact. {{KW:DELAY}}: Add the next {{TRIBE:CHRSPELL}} to your hand if an ally {{KW:SACRIFICE}} monster died this turn.",
	tribes: ["DOKI"],
	extension: "BASE",
	typeSkin: 2,
